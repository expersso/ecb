...
[![Travis-CI Build Status](https://travis-ci.org/NA/NA.svg?branch=master)](https://travis-ci.org/expersso/ecb)
[![Coverage Status](https://img.shields.io/codecov/c/github/NA/NA/master.svg)](https://codecov.io/github/expersso/ecb?branch=master)
[![](http://cranlogs.r-pkg.org/badges/grand-total/ecb)](http://cran.r-project.org/web/packages/ecb)
...
At a first glance, most countries indeed seem to follow the prediction of a
negative relationship between wages and unemployment.
